...
func (r *PgxOrderRepository) FindById(id int) (*order.Order, error) {
...
func (r *PgxOrderRepository) Save(o *order.Order) (*order.Order, error) {
	_, err := r.conn.Exec(
		context.Background(),
		`
		INSERT INTO order (id, customer_id, product_id_list, total_price, status, created_at, updated_at) 
		VALUES ($1, $2, $3, $4, $5, $6, $7)
		`,
		o.ID, o.CustomerId, o.ProductIdList, o.TotalPrice, o.Status, o.CreatedAt, o.UpdatedAt,
	)
	if err != nil {
		return nil, err
	}
