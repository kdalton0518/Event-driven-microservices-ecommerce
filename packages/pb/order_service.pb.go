...
type CreateOrderRequest struct {
	...
	ProductList   []*CreateOrderRequest_Product `protobuf:"bytes,2,rep,name=product_list,json=productList,proto3" json:"product_list,omitempty"`
...
func (x *CreateOrderRequest) GetProductList() []*CreateOrderRequest_Product {
	if x != nil {
...
type CreateOrderRequest_Product struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateOrderRequest_Product) Reset() {
	*x = CreateOrderRequest_Product{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateOrderRequest_Product) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateOrderRequest_Product) ProtoMessage() {}

func (x *CreateOrderRequest_Product) ProtoReflect() protoreflect.Message {
	mi := &file_protos_order_service_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateOrderRequest_Product.ProtoReflect.Descriptor instead.
func (*CreateOrderRequest_Product) Descriptor() ([]byte, []int) {
	return file_protos_order_service_proto_rawDescGZIP(), []int{4, 0}
}

func (x *CreateOrderRequest_Product) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CreateOrderRequest_Product) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateOrderRequest_Product) GetPrice() int32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *CreateOrderRequest_Product) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *CreateOrderRequest_Product) GetImageUrl() string {
	if x != nil {
		return x.ImageUrl
	}
	return ""
...
var file_protos_order_service_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x9a, 0x02, 0x0a,
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x3e, 0x0a, 0x0c, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x5f,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e,
	0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x25, 0x0a, 0x0e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f,
	0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x70, 0x61,
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x1a, 0x7c, 0x0a, 0x07, 0x50,
	...
	,
	...
	0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x36, 0x5a, 0x34,
...
var file_protos_order_service_proto_goTypes = []interface{}{
	...
	(*CreateOrderRequest_Product)(nil),           // 6: CreateOrderRequest.Product
}
var file_protos_order_service_proto_depIdxs = []int32{
	...
	6, // 2: CreateOrderRequest.product_list:type_name -> CreateOrderRequest.Product
...
func file_protos_order_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_order_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateOrderRequest_Product); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
